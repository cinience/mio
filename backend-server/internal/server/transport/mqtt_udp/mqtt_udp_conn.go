...
// GetRemoteAddr
func (c *MqttUdpConn) GetRemoteAddr() string {
	if c.UdpSession != nil && c.UdpSession.RemoteAddr != nil {
		return c.UdpSession.RemoteAddr.String()
	}
	return ""
}

func (c *MqttUdpConn) GetExternalAddr() string {
	if c.UdpSession != nil && c.UdpSession.Conn != nil {
		return fmt.Sprintf("udp://%s", c.UdpSession.Conn.LocalAddr().String())
	}
	return ""
}
